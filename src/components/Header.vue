<template>
  <header class="header">
    <div class="header__logo">
      ...
      <h2 class="sub_logo">
        <img src="../assets/img/sub_logo.png" alt="메인화면으로 이동" />
      </h2>
    </div>
    <nav class="header__menu">
      <ul>
        <li v-for="(list, i) in navArea.navList" :key="i">
          <span>{{ list.tit }}</span>
        </li>
      </ul>
    </nav>
    <div class="header__etc">
      <ul>
        ...
        <li class="locale_box">
          <img src="@/assets/img/locale_icon.png" alt="" />
        </li>
        <li class="login_box"><router-link to="/">로그인</router-link></li>
        <li class="join_box"><router-link to="/">회원가입</router-link></li>
      </ul>
    </div>
  </header>
</template>
