<template>
  <footer class="footer">
    <article class="ft_article">
      <span>언제나 리그 오브 레전드와 함께</span>
      <p>
        리그 오브 레전드 앱을 다운로드해 친구들과 대화하고 최신 게임 및 e스포츠
        소식을 확인해 보세요.
      </p>
      <div class="ft_art_img_box">
        <img
    ...
    <div class="ft_category">
      <ul>
        <li>
          <a href="">고객지원<i class="fa-brands fa-instagram"></i></a>
        </li>
        <li><a href="">학부모 전용 고객센터</a></li>
        <li><a href="">pc방</a></li>
        <li><a href="">라이엇 모바일 컴패니언 앱 다운로드</a></li>
      </ul>
    </div>
    <div class="ft_social">
      <ul>
    ...
    <div class="ft_copyright">
      ...
      <p>
        라이엇게임즈코리아 유한회사 서울특별시 강남구 테헤란로 521 30층 (삼성동,
        파르나스타워)<br />
        대표자 : 조혁진 | 대표전화 : 02-3454-1560 | FAX : 02-3454-1565
        사업자등록번호 : 120-87-68488<br />
        통신판매업신고 : 2011-서울강남-02718
      </p>
    </div>
    <div class="ft_legal_link">
      <ul>
